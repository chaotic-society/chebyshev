...
namespace prec {
	...
	namespace fail {
		...
		auto fail_on_max_err = [](const estimate_result& r) -> bool {
		...
		auto fail_on_mean_err = [](const estimate_result& r) -> bool {
		...
		/// is bigger than the tolerance or the error is NaN.
		auto fail_on_rms_err = [](const estimate_result& r) -> bool {
		...
		auto fail_on_rel_err = [](const estimate_result& r) -> bool {
